...
- **Tier 2** — explicitly supported, occasionally tested by hand. Expected to work; breakage is a
  bug. Not yet wired into CI.
...
| Android | arm64 | NDK r27c (Clang) | 2 | `android-ndk-arm64-*` presets; no CI yet |
