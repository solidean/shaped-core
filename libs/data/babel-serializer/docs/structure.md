...
Four decode behaviours babel's own encoder cannot produce are pinned by hand-built fixtures under `tests/image/fixtures/`, regenerated by the script beside them.
