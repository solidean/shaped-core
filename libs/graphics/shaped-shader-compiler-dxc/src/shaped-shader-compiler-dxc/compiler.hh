...
public:
    ...
    /// Instances on different threads may compile at the same time: nothing below the instance needs serializing.
    /// libs/graphics/shaped-shader-compiler-dxc/docs/thread-safety.md establishes that against the ThreadSanitizer
    /// reports that suggested otherwise.
