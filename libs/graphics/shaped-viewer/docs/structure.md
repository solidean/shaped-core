...
quadric primitives                       [planned]      a second scene_item_kind: analytic quadrics traced by a custom intersection shader over a procedural (AABB) BLAS, for drawing a mesh's vertices and edges at scale.
