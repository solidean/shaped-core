...
namespace sv
{
/// Inline payload budget for one parameter value: 4 components of 8 bytes.
///
...
inline constexpr i32 max_parameter_value_bytes = 32;
} // namespace sv
...
struct sv::parameter_value
{
    ...
    byte storage[max_parameter_value_bytes] = {};
    ...
    [[nodiscard]] static parameter_value of(T const& value)
    {
        ...
        static_assert(sizeof(T) <= max_parameter_value_bytes, "parameter value is too large to store inline");
