               ...
               (dx12::dx12_context_handle const& handle))
{
    ...
    sg::binding const bindings[] = {
        ...
        {.name = "Dyn", .index = 0, .count = 1, .type = sg::binding_type::sampler},
        {.name = "Static", .index = 1, .count = 1, .type = sg::binding_type::sampler},
    };
               ...
               (dx12::dx12_context_handle const& handle))
{
    ...
    pld.static_samplers.push_back({.binding = {.name = "Samp", .index = 0, .count = 1, .type = sg::binding_type::sampler},
