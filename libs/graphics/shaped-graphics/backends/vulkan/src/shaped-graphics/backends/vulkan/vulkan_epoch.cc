...
void vulkan_context::arm_completion_signal(u64 submission, u64 epoch)
{
...
void vulkan_context::park_for_completion_signal(u64 submission, u64 epoch, u64 wake_generation)
{
