...
///
/// Only declared when slib was built with the DXC compiler available (SLIB_HAS_DXC): DXC is Windows-only and fetched on demand, so the rest of slib builds and is tested without it.
