...
/// A filesystem over files compiled into the binary — what a shipped build reads when there is no source tree to mount over it.
/// Content is fixed, so every file sits at one constant revision and nothing ever reloads.
///
