...
public:
    ...
    /// Creates or replaces a file and bumps its revision.
    /// A path escaping the root asserts.
    void write(cc::string_view path, cc::string_view text);

    /// Removes a file; its revision drops back to `none`.
