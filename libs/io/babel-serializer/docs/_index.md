...
src/babel-serializer/
  ...
  all.hh          umbrella include (json + sqlite + obj)
  data/
...
- **Namespace `babel`**, with a sub-namespace per format (`babel::json`, `babel::sqlite`, `babel::obj`); internal details in `babel::impl`.
