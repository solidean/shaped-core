...
TEST("unique_function - return type preservation")
{
    ...
    SECTION("return const lvalue reference")
    {
        ...
        // f() comes back with a garbage address.
        // A confirmed compiler codegen bug, reproduced with a dependency-free repro — not a lifetime issue here.
        ...
        // Filed upstream: https://developercommunity.visualstudio.com/t/MSVC-O2-miscompiles-returned-const-loca/11114080
