...
- [test-runtime](test-runtime.md) — keeping a test's runtime proportional to what it proves: `nx::is_thorough()` narrows an expensive test for the default run, and a profiled run finds the slow one.
