...
function(sc_add_example target)
    ...
    # Examples share output directories, which is why this goes through sc_stage_runtime_dlls — see RuntimeDlls.cmake.
    sc_stage_runtime_dlls(${target} DLLS "$<TARGET_RUNTIME_DLLS:${target}>")
endfunction()
